...
-   I am calculating the mean number of hours of sleep on weekends for participants, which is `r mean(nlsy$sleep_wknd, na.rm = TRUE)`. <br>
...
-   I am calculating the median number of hours of sleep on weekends for participants, which is `r median(nlsy$sleep_wknd, na.rm = TRUE)`. 
